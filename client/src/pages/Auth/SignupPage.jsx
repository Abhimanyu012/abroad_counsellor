...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(result.redirect || '/onboarding')
        } catch (err) {
    ...
    return (
        <PageWrapper className="flex items-center justify-center min-h-screen p-4">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <div className="gradient-orb w-[600px] h-[600px] top-[10%] right-[10%] bg-violet-500/10 blur-[100px]" />
                <div className="gradient-orb w-[500px] h-[500px] bottom-[10%] left-[10%] bg-emerald-500/5 blur-[100px]" style={{ animationDelay: '-5s' }} />
            </div>
            ...
            >
                ...
                <GlassCard className="backdrop-blur-2xl">
                    ...
                    <p className="text-center text-zinc-400 text-sm">
                        ...
                        <Link to="/login" className="text-violet-400 hover:text-violet-300 font-medium hover:underline decoration-violet-400/30 underline-offset-4 transition-all">
                            Sign in
                        </Link>
                    </p>
                </GlassCard>
